...
const app = express();
const PORT = process.env.PORT || 3001; // Vercel asigna un puerto dinámico
...
// Configuración de la conexión a MySQL con Pooling para entornos serverless
...
const JWT_SECRET = process.env.JWT_SECRET; // Clave secreta para JWT
...
// Iniciar el servidor solo si no estás en un entorno de serverless
